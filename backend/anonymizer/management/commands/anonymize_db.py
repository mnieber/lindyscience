...
from anonymizer.base import ANONYMIZER_MODULE_NAME, BaseAnonymizer
...
class Command(BaseCommand):
    ...
    def handle(self, app, models, batch_size, *args, **options):
        ...
        for module in modules:
            ...
            for anonymizer_class_name in anonymizers:
                ...
                print(
                    "-- {} fields, {} model instances, {} total replacements".format(
    ...
    def _autodiscover_module(self, module_name, app=None):
        apps_to_search = (
            [app] if app else [x.split(".apps.")[0] for x in settings.INSTALLED_APPS]
        )
