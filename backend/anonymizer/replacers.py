...
from .data.de import cities as _data_cities
from .data.de import first_names as _data_first_names
from .data.de import last_names as _data_last_names
...
def email(**kwargs):
    return "{}.{}@blueshoe-testdata.de".format(
        first_name(**kwargs), last_name(**kwargs)
    )
