...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameField(
            model_name='MoveTip', old_name='move_uuid', new_name='move'),
        migrations.RemoveField('MoveVideoLink', 'move'),
        migrations.RenameField(
            model_name='MoveVideoLink', old_name='move_uuid', new_name='move'),
        ...
        migrations.AlterField(
            model_name='MovePrivateData',
            name='move',
            field=models.ForeignKey('Move', on_delete=models.CASCADE),
        ),
    ]
