...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "move",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="moves.Move"
                    ),
                ),
                (
                    "move_list",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="moves.MoveList"
                    ),
                ),
            ],
        ...
        migrations.AlterUniqueTogether(
            name="tagulous_movelist_tags", unique_together={("slug",)},
        ),
        migrations.AlterUniqueTogether(
            name="tagulous_move_tags", unique_together={("slug",)},
        ),
        migrations.AddField(
            model_name="movelist",
            name="moves",
            field=models.ManyToManyField(
                through="moves.MoveList2Move", to="moves.Move"
            ),
        ),
        migrations.AddField(
            model_name="movelist",
