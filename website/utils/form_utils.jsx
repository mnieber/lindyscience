...
export function formField(errors, label, field) {
  return (
    <React.Fragment>
      <div htmlFor={field.props.id} className="labeledField__label">{label}</div>
...
export function formFieldProps(formProps, fieldName, classNames) {
  return {
    ...
    className: classnames(
      classNames,
      {'error': formProps.errors && formProps.errors[fieldName] && formProps.touched[fieldName]}
    )
  }
}
...
export function formFieldError(formProps, fieldName, classNames, key) {
  if (formProps.errors && formProps.errors[fieldName] && formProps.touched[fieldName]) {
      return (
